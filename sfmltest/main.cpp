    ...
    while (game.App.isOpen())///**************************************************************************************************************************GAME LOOP OPEN
    {
        ...
        if(!gameended)
        {
            if (sf::Keyboard::isKeyPressed ( sf::Keyboard::W ) and (playa.canWalkUp(currentroom.floortile,game) ))
                playa.y-=playa.speed;
            if(sf::Keyboard::isKeyPressed ( sf::Keyboard::W ) and currentroom.dtop and game.dti.getPixel(playa.x,playa.y-15)==dor and currentroom.type!=1)
            {
                changeRoom(currentroom,0,section);
                playa.y+=580;
            }
            ...
            if (sf::Keyboard::isKeyPressed ( sf::Keyboard::S ) and playa.canWalkDown(currentroom.floortile,game  ))
                playa.y+=playa.speed;
            if(sf::Keyboard::isKeyPressed ( sf::Keyboard::S )and currentroom.dbottom and (game.dbi.getPixel(playa.x,playa.y+20)==dor) and currentroom.type!=1)
            {
                changeRoom(currentroom,2,section);
                playa.y-=580;
            }
            ...
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::A) and (playa.canWalkLeft(currentroom.floortile,game)))
                playa.x-=playa.speed;
            if(sf::Keyboard::isKeyPressed(sf::Keyboard::A) and currentroom.dleft and game.dli.getPixel(playa.x-15,playa.y)==dor and currentroom.type!=1)
            {
                changeRoom(currentroom,3,section);
                playa.x+=1500;
            }
            ...
            if (sf::Keyboard::isKeyPressed(sf::Keyboard::D) and (playa.canWalkRight(currentroom.floortile,game) ))
                playa.x+=playa.speed;
            if(sf::Keyboard::isKeyPressed(sf::Keyboard::D) and currentroom.dright and game.dri.getPixel(playa.x+20,playa.y)==dor and currentroom.type!=1)
            {
                changeRoom(currentroom,1,section);
                playa.x-=1500;
            }
        ...
        if(!gameended)
        {
            ...
            for(int unsigned i=0; i<currentroom.proj.size(); ++i)
            {
                ...
                if(sqrt( ((currentroom.proj[i].x - playa.x)  *  (currentroom.proj[i].x - playa.x))  +  ((currentroom.proj[i].y - playa.y)  *  (currentroom.proj[i].y - playa.y))) <15  &&  currentroom.proj[i].orig!=&playa && !playa.invincible and !playa.red)
                {
                ...
                {
                    mainboss.y-=50;
                    if(sqrt( ((currentroom.proj[i].x - mainboss.x)  *  (currentroom.proj[i].x - mainboss.x))  +  ((currentroom.proj[i].y - mainboss.y)  *  (currentroom.proj[i].y - mainboss.y))) <150  &&  currentroom.proj[i].orig==&playa && !mainboss.invincible and !mainboss.red)
                    {
            ...
            for(int unsigned i=0; i<currentroom.enem.size(); ++i)
            {
                ...
                {
                    if(!currentroom.enem[i].destroystate and sqrt( ((currentroom.proj[j].x - (currentroom.enem[i].x))  *  (currentroom.proj[j].x - (currentroom.enem[i].x)))  +  ((currentroom.proj[j].y - (currentroom.enem[i].y))  *  (currentroom.proj[j].y - (currentroom.enem[i].y)))) <15  &&  currentroom.proj[j].orig==&playa)
                    {
